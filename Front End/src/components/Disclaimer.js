...
import { getDisclaimers } from "../services/disclaimerService";
       ...
       {disclaimers && disclaimers.map(disclaimer => (
        ...
        <ul>
          <li>
            <p>
              ...
              this Disclaimer) refers to Good Neighbor.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              the Company downloaded by You on any electronic device named Good
              Neighbor.
            </p>
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            <a
              href="www.goodneighbor.org"
              rel="external nofollow noopener"
              target="_blank"
            >
              www.goodneighbor.org
            </a>
          </li>
        </ul>
    </DisclaimerContainer>
