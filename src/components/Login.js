    ...
    return (
      <LoginContainer>
        <LoginInnerContainer>
          ...
          <p>is a volunteer-based platform where neighbors help neighbors in need.<br/>Please note that due to limited resources, we are only able to serve the city of <strong>East Boston</strong> at this time.</p><br/>
